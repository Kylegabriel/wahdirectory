                ...
                <form method="GET" action="{{ route('summary.index') }}">
                    <div class="row">
                        <div class="input-field col s5">
                            ...
                            <label for="partnerOrganization">Filter By Organization:</label>
                        </div>
                        <div class="input-field col s5">
                            ...
                            <label for="partnerDesignation">Filter By Designation:</label>
                        </div>
                        ...
                        <table class="table bordered centered highlight responsive-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $summ->organization }}</td>
                                    <td>{{ $summ->designation }}</td>
                                    <td>{{ $summ->status }}</td>
